package MyModule::Build::Platform::MacOS;
...
# actually go in MyModule::Build::Base.  But we put it here to be less
...
MyModule::Build::Platform::MacOS - Builder class for MacOS platforms

=head1 DESCRIPTION

The sole purpose of this module is to inherit from
C<MyModule::Build::Base> and override a few methods.  Please see
L<MyModule::Build> for the docs.
