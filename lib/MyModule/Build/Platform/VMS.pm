package MyModule::Build::Platform::VMS;
...
MyModule::Build::Platform::VMS - Builder class for VMS platforms

=head1 DESCRIPTION

This module inherits from C<MyModule::Build::Base> and alters a few
minor details of its functionality.  Please see L<MyModule::Build> for
the general docs.
