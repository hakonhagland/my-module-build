...
my $PPM_support = MyModule::Build::ConfigData->feature('PPM_support');
my $manpage_support = MyModule::Build::ConfigData->feature('manpage_support');
my $HTML_support = MyModule::Build::ConfigData->feature('HTML_support');
...
my $perl_version = MyModule::Build::PPMMaker->_ppd_version($mb->perl_version);
my $varchname = MyModule::Build::PPMMaker->_varchname($mb->config);
