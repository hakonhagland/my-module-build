...
{
  # Fake out Module::Signature and MyModule::Build - the first one to
  ...
  my @run_order;
  {
    ...
    *Module::Signature::sign = sub { push @run_order, 'sign' };
    local *MyModule::Build::Base::ACTION_distmeta;
    *MyModule::Build::Base::ACTION_distmeta = sub { push @run_order, 'distmeta' };
    eval { $mb->dispatch('distdir') };
  }
  is $@, '';
